                  ...
                  {players.filter(p => p !== bopCoWinner).map(player => {
                    ...
                    return (
                      <div key={player} className="bop-co-player-card">
                        ...
                        <div className="bop-co-heo-checkboxes">
                          <label className={`heo-checkbox-label ${hasDen ? 'checked-den' : ''}`}>
                            <input
                              type="checkbox"
                              checked={hasDen}
                          ...
                          <label className={`heo-checkbox-label ${hasDo ? 'checked-do' : ''}`}>
                            <input
                              type="checkbox"
                              checked={hasDo}
